...
public class OfficeTablePojo {
    ...
    public static List<OfficeTablePojo> convertToOfficeTablePojo(List<Object[]> objectList){
        List<OfficeTablePojo> offices = new ArrayList<>();
            //int rowIndex = 0;
            BigDecimal rowIndex = new BigDecimal(1.0);
            for(Object[] obj : objectList){
                OfficeTablePojo off = new OfficeTablePojo();
